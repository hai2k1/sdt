...
use Botble\Bycode\Tables\HistoryByCodeTable;
...
class HistoryByCodeController extends BaseController
{
    /**
     * @var BycodeInterface
     */
     ...
     */
    public function index(HistoryByCodeTable $table)
    {
        page_title()->setTitle(trans('History by code'));
